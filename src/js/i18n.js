...
const DICT = {
  ja: {
    ...
    'settings.audience.title':     '親しい友達 / オーガニゼーション',
    'settings.audience.hint':      '投稿時に「親しい友達のみ」を選ぶと、ここで指定した人たち + 同じオーガニゼーションのメンバーだけに表示されます。',
    'settings.audience.friends':   '親しい友達のハンドル（カンマ区切り）',
    'settings.audience.org':       'オーガニゼーション',
  ...
  en: {
    ...
    'settings.audience.title':     'Close friends / Organization',
    'settings.audience.hint':      'When you mark a post as "Close friends only" in the composer, it is visible only to the handles listed here + anyone who shares the same organization with you.',
    'settings.audience.friends':   'Close-friend handles (comma-separated)',
    'settings.audience.org':       'Organization',
