...
const DICT = {
  ja: {
    ...
    'settings.audience.hint':      '投稿時に「親しい友達」「同じ組織」を選んだとき、ここで指定したハンドルのユーザーだけに表示されます。自分でハンドルを追加・削除して管理してください。',
    'settings.audience.friends':   '親しい友達のハンドル（カンマ区切り）',
    'settings.audience.org_members':'同じ組織のメンバー（カンマ区切り）',
  ...
  en: {
    ...
    'settings.audience.hint':      'When you mark a post as "Close friends" or "Same organization" in the composer, only the handles you list here can see it. Add or remove handles manually.',
    'settings.audience.friends':   'Close-friend handles (comma-separated)',
    'settings.audience.org_members':'Org-member handles (comma-separated)',
