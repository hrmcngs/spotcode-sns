...
const DICT = {
  ja: {
    ...
    'settings.audience.hint':      '投稿時に「親しい友達」「同じ組織」を選んだときに見せる人を、検索して追加・×で削除します。',
  ...
  en: {
    ...
    'settings.audience.hint':      'When you tag a post as "Close friends" or "Same organization", only the people on these lists can see it. Search to add, × to remove.',
